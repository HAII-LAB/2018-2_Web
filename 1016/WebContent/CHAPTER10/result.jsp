                    ...
                    <table width="680" border="0" cellpadding="0" cellspacing="0" id="registerform">
                      <tr>
                        ...
                        <td><label for="idfield2"></label>
                          <%=request.getParameter("idfield") %></td>
                      </tr>
                      <tr>
                        <th><label for="pwfield">* 비밀번호</label></th>
                        <td><label for="pwfield"></label>
                         <%=request.getParameter("pwfield") %></td>
                      </tr>
                      <tr>
                        <th rowspan="2"><label for="emailfield">* 이메일</label></th>
                        <td><label for="email"></label>
                        <%=request.getParameter("email") %>@<%=request.getParameter("select") %></td>
                      </tr>
                      <tr>
                        <td height="35"><%=request.getParameter("RadioGroup1") %><br></td>
                      </tr>
                      <tr>
                        <th>* 관심정보</th>
                        <td><p>
