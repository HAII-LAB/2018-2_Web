...
<%@ page import="my.model.Customer, my.dao.CustomerDao, java.sql.*, my.util.*" %>
...
<body>
	...
	<jsp:useBean id="customer" class="my.model.Customer"/>
	...
	<div class="page_content">
		...
		<%
        	...
        	try{
        		...
        		customer.setRegisterTime(new java.util.Date());
