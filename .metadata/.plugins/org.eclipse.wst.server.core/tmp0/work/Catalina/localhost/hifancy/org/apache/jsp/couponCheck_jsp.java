 ...
 * Generated at: 2018-12-11 10:49:06 UTC
...
public final class couponCheck_jsp extends org.apache.jasper.runtime.HttpJspBase
			...
			String userId=(String)session.getAttribute("UI");
 			...
 			Connection conn=ConnectionProvider.getConnection();
          	...
          	try{
          		...
          		coupon=dao.selectById(conn, couponId);
          		if(coupon.getUserId()==userId.trim()){
          			
      out.write("\r\n");
      out.write("          \t\t\t<script>\r\n");
      out.write("          \t\t\t alert(\"쿠폰아이디가 확인되었습니다.\");\r\n");
      out.write("          \t\t\t</script>\r\n");
      out.write("          \t\t\t");

          			response.sendRedirect("productCartList.jsp?couponIdValid=yes");
          		}else{
          			
      out.write("\r\n");
      out.write("          \t\t\t<script>\r\n");
      out.write("          \t\t\t alert(\"유효하지 않은 쿠폰아이디입니다.\");\r\n");
      out.write("          \t\t\t</script>\r\n");
      out.write("          \t\t\t");

          			response.sendRedirect("productCartList.jsp?couponIdValid=no");
          		}
