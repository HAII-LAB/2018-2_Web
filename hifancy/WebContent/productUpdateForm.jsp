  ...
  <div align="center"><a href="#"><img src="images/pageheader_12.png" width="86" height="62" /></a><br>
    <a href="#">마이페이지</a></div>
      ...
      <div id="body2">
        ...
        <div id="guide">어떤 상품을 수정하시나요? 새로운 상품 정보를 입력하세요!</div>
        <p>&nbsp;</p>
        ...
        <form action="productUpdate.jsp" method="post" enctype="multipart/form-data" name="form1">
                <table width="956" border="2" align="center" cellpadding="10" cellspacing="0" id="registerform">
                      ...
                      <tr>
                        ...
                        <td>
                        <input name="productprice" cols="70" rows="10" value="${product.productprice}"></td>
                      </tr>
                      <tr>
                       ...
                       <select name="productType" value="${product.productType}">
                           ...
                           <option value="리빙/데코">리빙데코</option>
                      ...
                      <tr>
                        ...
                        <td>
                        <input type="file" name="productImage" value="${product.productImage}"></td>
                      </tr>
                      <tr>
                        <th bgcolor="#80A6AD"><label for="infofield">
                          상품설명
                        </label></th>
                        <td><textarea name="productInfo" value="${product.productInfo}"></textarea></td>
                      </tr>
